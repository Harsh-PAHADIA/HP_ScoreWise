    ...
    <div className="animate-fade-in">
      ...
      <div className="py-12 md:py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-black mb-6">
          Simplify Assessment <span className="text-neutral-500">Evaluation</span>
        </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="h-12 w-12 bg-neutral-100 text-black rounded-lg flex items-center justify-center mb-4">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="h-16 w-16 bg-black text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">1</div>
            ...
            <div className="text-center">
              <div className="h-16 w-16 bg-black text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">2</div>
            ...
            <div className="text-center">
              <div className="h-16 w-16 bg-black text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">3</div>
      ...
      <div className="py-16 bg-black text-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-neutral-300">
            Join educators and students who are already using HP_ScoreWise to streamline the assessment process.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/register">
            ...
            <Link to="/login">
              <Button variant="outline" size="lg" className="bg-transparent border-white text-white hover:bg-neutral-900 px-8">
                Login
              </Button>
            </Link>
          </div>
