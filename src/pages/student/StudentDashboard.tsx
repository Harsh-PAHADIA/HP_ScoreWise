        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center">
              <div className="mr-4 bg-neutral-100 p-3 rounded-full">
            ...
            {pendingAssessments.length === 0 ? (
              ...
              <div className="space-y-4">
                {pendingAssessments.slice(0, 5).map((assessment) => (
                  <div
                    key={assessment.id}
                    className="p-4 border border-neutral-100 rounded-md hover:border-neutral-200 transition-colors"
                  >
                    ...
                    >
                      <Link to={`/student/results/${submission.id}`} className="block">
                        <div className="flex justify-between mb-1">
                          <h4 className="font-medium text-black hover:text-neutral-600 transition-colors">
                            {assessment.title}
                          </h4>
                          <div className="flex items-center">
                            {isPassed ? (
                            ...
                            <span className={`text-sm font-medium ${isPassed ? 'text-success-500' : 'text-error-500'
                              }`}>
                              {percentage}%
                            </span>
                          </div>
